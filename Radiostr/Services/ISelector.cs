...
namespace Radiostr.Services
{
    ...
    public interface ISelector
    {
        ...
        /// </summary>
        Task<Schedule> Select(string stationId, int[] libraryIds, int trackCount);

        /// <summary>
        /// Selects a Schedule of at least the specified duration.
        /// </summary>
        Task<Schedule> Select(string stationId, int[] libraryIds, TimeSpan duration);

        /// <summary>
        /// Selects a Schedule for broadcast at startTime for at least the specified duration.
        /// </summary>
        Task<Schedule> Select(string stationId, int[] libraryIds, DateTime startTime, DateTimePrecision precision, TimeSpan duration);
    }
}
